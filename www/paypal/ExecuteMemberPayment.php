    ...
    <section class="section">
        <div class="container">
            <div class="col-sm-6 col-sm-offset-3 text-center">
                ...
                <h6 style="margin-top:20px;">Fee Review</h6>
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><label class="text-rose">$10</label><br></td>
                    </tr>
                </table>
                ...
                <p><a onclick="$('.process-overlay').show();$('.proccessing').show();" href="ExecuteMemberPayment?agreement=confirm" class="btn btn-sm">Confirm Payment</a></p>
